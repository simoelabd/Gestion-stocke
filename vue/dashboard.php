...
<div class="home-content">
        <div class="overview-boxes">
          <div class="box">
            <div class="right-side">
              ...
              <div class="number">
                <?php 
                    $AllCommande = new AllCommande($conn);
                    $result = $AllCommande->getAllCommande()['nbr'];
                    print_r($result);
                  ?>
              </div>
              <div class="indicator">
          ...
          <div class="box">
            <div class="right-side">
              ...
              <div class="number">
                <?php 
                  $Allvente = new Allvente($conn);
                  $result = $Allvente->getAllVente()['nbr'];
                  print_r($result);
                ?>
              </div>
              <div class="indicator">
          ...
          <div class="box">
            <div class="right-side">
              ...
              <div class="number">
                <?php 
                  $Allarticle = new Allarticle($conn);
                  $result = $Allarticle->getAllArticle()['nbr'];
                  print_r($result);
                ?>
              </div>
              <div class="indicator">
          ...
          <div class="box">
            <div class="right-side">
              <div class="box-topic">Le chiffre d'affaires (CA)</div>
              <div class="number">
              <?php 
                  $CAManager = new CAManager($conn);
                  $result = $CAManager->getCA()['prix'];
                  print_r($result);
                ?>DH
              </div>
              <div class="indicator">
        ...
        <div class="sales-boxes">
          <div class="recent-sales box">
            ...
            <?php
              $ventes = new LastVente($conn);
              $ventes = $ventes->getLastVente();
            ?>
          ...
          <div class="top-sales box">
            ...
            <?php
              $article = new MostVente($conn);
              $article = $article->getMostVente();
