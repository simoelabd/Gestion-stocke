...
include 'entet.php';
if(!empty($_GET['id'])){
    $venteManager = new VenteManager($conn);
    $vente = $venteManager->getVente($_GET['id']);
}
...
<div class="home-content">
    <div class="overvie-boxes">
        <div class="overview-boxes">
            <div class="box">
                <form action="<?= !empty($_GET['id']) ? "../model/modiVente.php" : "../model/ajoutVente.php"?> " method="post">
